...
!-----------------------------------------------------------------------------
  public :: init_GDASNC      !defines the native resolution of
                                  !the input data
!-----------------------------------------------------------------------------
! !PUBLIC TYPES:
!-----------------------------------------------------------------------------
...
!EOP
    ...
    ! Read in LIS config file entries for GDASNC dataset
    call readconfig_gdasnc()

    ! Number of met variables in GDAS forcing
    gdas_struc(:)%nmif    = 9
  ...
  end subroutine init_GDASNC

end module gdasnc_forcingMod
